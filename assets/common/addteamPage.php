                                        ...
                                        <div class="form">
                                            <div class="form-group from-show-notify row">
                                                ...
                                                <div class="col-lg-6 col-md-9 col-sm-12">
                                                    <input type="text" class="form-control" id="id" placeholder="请输入团队名称">
                                                </div>
                                            </div>
                                            <div class="form-group from-show-notify row">
                                                <div class="col-lg-4 col-md-3 col-sm-12 text-right">
                                            ...
                                            <div class="form-group from-show-notify row">
                                                ...
                                                <div class="col-lg-6 col-md-9 col-sm-12">
                                                    <input type="text" class="form-control" id="password" placeholder="请输入队长学号">
                                                </div>
                                            </div>
                                            <div class="form-group from-show-notify row">
                                                <div class="col-lg-4 col-md-3 col-sm-12 text-right">
                                                    <label>团队队员(至少一人):</label>
                                                </div>
                                                <div class="col-lg-6 col-md-9 col-sm-12">
                                                    <input type="text" class="form-control" id="real_name" placeholder="请输入队员学号">
                                                    <input type="text" class="form-control" id="real_name" placeholder="请输入队员学号">
                                                    <input type="text" class="form-control" id="real_name" placeholder="请输入队员学号">
                                                    <input type="text" class="form-control" id="real_name" placeholder="请输入队员学号">
                                                </div>
